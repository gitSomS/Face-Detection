...
label1.grid(row=0,column=1, padx = (950,0), pady = (10,500))

label2=Label(window,text="Nome")
label2.grid(row=1,column=3, padx = (300,0), pady = (1,1))

label3=Label(window,text="Apelido")
label3.grid(row=2,column=3, padx = (300,0), pady = (1,1))

label4=Label(window,text="Pontos")
label4.grid(row=3,column=3, padx = (300,0), pady = (1,1))

label5=Label(window,text="Crime")
label5.grid(row=4,column=3, padx = (300,0), pady = (1,1))
...
list1.grid(row=1,column=1, padx = (50,0), pady = (10,50), rowspan=6, columnspan=1)

scrl=Scrollbar(window)
scrl.grid(row=1,column=0, padx = (10,0), sticky='ns',rowspan=6)
